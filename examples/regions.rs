use pixel_sort::{U64_SIZE, Vec2U32, WorkgroupInfo, section::Section};

mod framework;

fn main() {
    framework::run::<Regions>();
}
...
impl framework::Example for Regions {
    ...
    fn new(
        ...
        let module = device.create_shader_module(wgpu::include_wgsl!("regions.wgsl"));
